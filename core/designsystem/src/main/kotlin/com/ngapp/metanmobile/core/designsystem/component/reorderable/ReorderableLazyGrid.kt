 ...
 * @param scroller The [Scroller] that will be used to scroll the grid. Use [rememberScroller](com.ngapp.metanmobile.core.designsystem.component.reorderable.ScrollerKt.rememberScroller) to create a [Scroller].
