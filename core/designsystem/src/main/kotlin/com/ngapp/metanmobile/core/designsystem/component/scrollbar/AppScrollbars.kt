...
package com.ngapp.metanmobile.core.designsystem.component.scrollbar
...
import com.ngapp.metanmobile.core.designsystem.component.scrollbar.ThumbState.Active
import com.ngapp.metanmobile.core.designsystem.component.scrollbar.ThumbState.Dormant
import com.ngapp.metanmobile.core.designsystem.component.scrollbar.ThumbState.Inactive
...
private fun scrollbarThumbColor(
    ...
    val color = animateColorAsState(
        targetValue = when (state) {
            Active -> MaterialTheme.colorScheme.onSurfaceVariant.copy(0.5f)
            Inactive -> MaterialTheme.colorScheme.onSurfaceVariant.copy(alpha = 0.2f)
