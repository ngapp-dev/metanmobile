...
package com.ngapp.metanmobile.core.model.recentsearch
...
data class SearchResult(
    ...
    val stationResources: List<StationResource> = emptyList(),
    val faqResources: List<FaqResource> = emptyList(),
    val careerResources: List<CareerResource> = emptyList(),
)
