...
import com.ngapp.metanmobile.core.datastore.SortingOrderProto
import com.ngapp.metanmobile.core.model.userdata.SortingOrder

fun SortingOrderProto.toModel(): SortingOrder {
    return when (this) {
        SortingOrderProto.UNRECOGNIZED -> SortingOrder.ASC
        SortingOrderProto.ASC -> SortingOrder.ASC
        SortingOrderProto.DESC -> SortingOrder.DESC
    }
}

fun SortingOrder.toProto(): SortingOrderProto {
    return when (this) {
