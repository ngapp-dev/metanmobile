...
fun NavController.navigateToLegalRegulations(navOptions: NavOptionsBuilder.() -> Unit = {}) {
    navigate(route = LegalRegulationsNavigation) { navOptions() }
}
...
@Serializable
data object LegalRegulationsNavigation