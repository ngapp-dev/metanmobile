...
internal fun ThemeModeRowItem(
    ...
    val themeModeName = when (themeMode) {
        DarkThemeConfig.LIGHT -> R.string.feature_menu_main_text_theme_mode_light
        DarkThemeConfig.DARK -> R.string.feature_menu_main_text_theme_mode_dark
        DarkThemeConfig.FOLLOW_SYSTEM -> R.string.feature_menu_main_theme_mode_system_default
    }
    ...
    Row(
        ...
        Text(
            text = stringResource(id = themeModeName),
            overflow = TextOverflow.Ellipsis,
