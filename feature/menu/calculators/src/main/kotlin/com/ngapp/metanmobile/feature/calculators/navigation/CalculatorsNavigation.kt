...
fun NavController.navigateToCalculators(navOptions: NavOptionsBuilder.() -> Unit = {}) {
    navigate(route = CalculatorsNavigation) { navOptions() }
}
...
@Serializable
data object CalculatorsNavigation