    ...
    Row(
        ...
        Row(
            ...
            MMFilledIconButton(
                ...
                contentDescription = stringResource(R.string.feature_stationdetail_description_share_station),
...
internal fun HeaderButtons(
    ...
    Row(
        ...
        ButtonWithIcon(
            ...
            textResId = R.string.feature_stationdetail_button_directions,
            containerColor = Blue,
            contentColor = White,
        ...
        ButtonWithIcon(
            ...
            textResId = R.string.feature_stationdetail_button_call,
        ...
        ButtonWithIcon(
            ...
            textResId = if (isFavorite) R.string.feature_stationdetail_button_saved else R.string.feature_stationdetail_button_save,
        ...
        ButtonWithIcon(
            imageVector = MMIcons.Share,
            textResId = R.string.feature_stationdetail_button_share,
            containerColor = LightBlue,
            contentColor = Blue,
            shape = ShapeDefaults.ExtraLarge,
            onClick = { onShareClick() }
